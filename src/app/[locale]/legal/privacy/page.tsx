...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <Typography.P>
        <strong>2.5. Данни от формуляра за реклама и партньорства:</strong> Име,
        имейл адрес, име на бизнеса и свободно текстово съобщение, които Вие
        изпращате чрез контактния формуляр на страницата за реклама. Тези данни
        не се събират автоматично — обработваме ги единствено ако Вие съзнателно
        изпратите формуляра.
      </Typography.P>
      <Typography.P>
        Цел: Разглеждане на запитването и връзка с Вас относно евентуално
        партньорство или рекламно присъствие в All4Ruse.
      </Typography.P>
      ...
      <ul className="not-prose mb-6 list-disc pl-6 [li]:mt-1">
        <li>
          ...
          Общите условия, както и за преддоговорни стъпки по Ваше искане при
          запитване за реклама или партньорство чрез контактния формуляр.
        </li>
        <li>
        ...
        <li>
          <strong>Легитимен интерес</strong> (Чл. 6, ал. 1, б. „ф&quot; от
          GDPR): За защита на сайта от хакерски атаки, предотвратяване на
          злоупотреби и поддържане на стабилността на услугата.
        </li>
      </ul>
      ...
      <ul className="not-prose mb-6 list-disc pl-6 [li]:mt-1">
        ...
        <li>
          ...
          деперсонализирана статистика за посещаемостта на уебсайта след изрично
          съгласие от Ваша страна.
        </li>
        <li>
          <strong>Meta Pixel (Meta Platforms Ireland Ltd.):</strong> Използва се
          след Ваше съгласие за измерване на ефективността на рекламни кампании,
          аудитории и действия след взаимодействие с реклама.
        </li>
        <li>
      ...
      <Typography.P>
        Личните данни, свързани с Вашия профил, се съхраняват за целия период, в
        който профилът Ви е активен. Вие имате възможност да изтриете профила си
        по всяко време. При изтриване на профила, личните Ви данни се заличават
        перманентно от нашите активни бази данни в Supabase в рамките на 30 дни.
      </Typography.P>
      <Typography.P>
        Данните от формуляра за реклама и партньорства се съхраняват до 24
        месеца след последната кореспонденция по запитването, освен ако закон не
        изисква по-дълъг срок.
      </Typography.P>
      ...
      <ul className="not-prose mb-6 list-disc pl-6 [li]:mt-1">
        ...
        <li>
          Право на изтриване („Право да бъдете забравен&quot;) – чрез изтриване
          на профила или искане по имейл.
        </li>
