  ...
  return (
    ...
    >
      ...
      <Typography.P>
        ...
        браузър, операционна система, история на посетените страници в сайта,
        време на престой и данни за взаимодействие с рекламни кампании, когато
        сте дали съгласие за аналитични или маркетингови бисквитки.
      </Typography.P>
      <Typography.P>
        Цел: Осигуряване на киберсигурност на платформата, анализ на
        потребителския трафик с цел оптимизация и измерване на ефективността на
        рекламните кампании.
      </Typography.P>
      ...
      <ul className="not-prose mb-6 list-disc pl-6 [li]:mt-1">
        ...
        <li>
          ...
          при доброволно попълване на незадължителни данни, както и за
          аналитични и маркетингови бисквитки като Google Analytics и Meta
          Pixel.
        </li>
        <li>
          <strong>Легитимен интерес</strong> (Чл. 6, ал. 1, б. „ф&quot; от GDPR):
          За защита на сайта от хакерски атаки, предотвратяване на злоупотреби
          и поддържане на стабилността на услугата.
        </li>
      </ul>
      ...
      <ul className="not-prose mb-6 list-disc pl-6 [li]:mt-1">
        ...
        <li>
          ...
          деперсонализирана статистика за посещаемостта на уебсайта след
          изрично съгласие от Ваша страна.
        </li>
        <li>
          <strong>Meta Pixel (Meta Platforms Ireland Ltd.):</strong> Използва
          се след Ваше съгласие за измерване на ефективността на рекламни
          кампании, аудитории и действия след взаимодействие с реклама.
        </li>
        <li>
